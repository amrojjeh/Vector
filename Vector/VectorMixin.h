...
{																																				\
	...
	return result;																																\
																																				...
																																				\
template<typename T __VA_ARGS__> Physics::Vector<T, n> Physics::Vector<T, n>::Multiply(T other) const											\
{																																				\
	return {};\
}																																				\
																																				\
...
{																																				\
	return Subtract(other);																														\
																																				...
																																				\
template<typename T __VA_ARGS__> Physics::Vector<T, n> Physics::Vector<T, n>::operator*(T other) const											\
{																																				\
